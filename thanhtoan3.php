            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 clearfix" id="checkout">
                        ...
                        <div class="box">
                            <form method="post" action="index.php?p=thanhtoan4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="box payment-method">
                                                ...
                                                <div class="box-footer text-center">
                                                    ...
                                                    <input type="radio" name="payment" value="payment">An toàn nhất.
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="box-footer">
                                    <div class="pull-left">
                                        <a href="<?= BASE_URL ?>index.php?p=thanhtoan2" class="btn btn-default"><i class="fa fa-chevron-left"></i>Trở lại</a>
                                    </div>
